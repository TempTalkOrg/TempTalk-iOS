...
RECORD_TYPE_SWIFT="TTServiceKit/src/Storage/Database/SDSRecordType.swift"
...
$REPO_ROOT/Scripts/sds_codegen/sds_generate.py  --src-path TTServiceKit/  --search-path .  $GENERATE_ARGS
$REPO_ROOT/Scripts/sds_codegen/sds_generate.py  --src-path TTShareExtension/  --search-path .  $GENERATE_ARGS
$REPO_ROOT/Scripts/sds_codegen/sds_generate.py  --src-path TTMessaging/  --search-path .  $GENERATE_ARGS
$REPO_ROOT/Scripts/sds_codegen/sds_generate.py  --src-path TempTalk  --search-path .  $GENERATE_ARGS
