...
def update_objc_snippet(file_path, snippet):
    ...
    snippet = '// This snippet is generated by %s. Do not manually edit it, instead run `sds_codegen.sh`. Please contact Kris for support.' % ( sds_common.pretty_module_path(__file__), ) + '\n\n' + snippet
