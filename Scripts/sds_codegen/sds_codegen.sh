...
# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTServiceKit/ --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTShareExtension/ --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTMessaging --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TempTalk --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes

# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTServiceKit/src/Messages/Interactions/ --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
# $REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTServiceKit/src/Contacts/ --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
$REPO_ROOT/Scripts/sds_codegen/sds_parse_objc.py --src-path TTServiceKit/src/ --swift-bridging-path $REPO_ROOT/Scripts/sds_codegen/sds-includes
