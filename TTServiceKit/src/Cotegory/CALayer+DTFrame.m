...
#import "CALayer+DTFrame.h"

extern UIViewContentMode convertGravityToUIViewContentMode(NSString *gravity);
extern NSString *convertViewContentModeToCAGravity(UIViewContentMode contentMode);

@implementation CALayer (DTFrame)
...
- (UIViewContentMode)contentMode {
    return convertGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = convertViewContentModeToCAGravity(contentMode);
}
...
UIViewContentMode convertGravityToUIViewContentMode(NSString *gravity) {
...
NSString *convertViewContentModeToCAGravity(UIViewContentMode contentMode) {
    switch (contentMode) {
