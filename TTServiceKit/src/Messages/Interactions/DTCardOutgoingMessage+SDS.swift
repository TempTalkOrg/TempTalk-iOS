...
@objc
public extension DTCardOutgoingMessage {
    // NOTE: This method will fail if the object has unexpected type.
    class func anyFetchDTCardOutgoingMessage(
        uniqueId: String,
        transaction: SDSAnyReadTransaction
    ) -> DTCardOutgoingMessage? {
        ...
        guard let instance = object as? DTCardOutgoingMessage else {
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateDTCardOutgoingMessage(transaction: SDSAnyWriteTransaction, block: (DTCardOutgoingMessage) -> Void) {
...
class DTCardOutgoingMessageSerializer: SDSSerializer {

    private let model: DTCardOutgoingMessage
    public required init(model: DTCardOutgoingMessage) {
        self.model = model
    }
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let recordType: SDSRecordType = .dTCardOutgoingMessage
