...
+ (TSQuotedMessage *)quotedMessageForQuoteProto:(DSKProtoDataMessageQuote *)quoteProto
...
//    }
    ...
    for (DSKProtoDataMessageQuoteQuotedAttachment *quotedAttachment in quoteProto.attachments) {
        hasAttachment = YES;
        ...
        if (thumbnailStream) {
            ...
            DSKProtoAttachmentPointer *thumbnailAttachmentProto = quotedAttachment.thumbnail;
            TSAttachmentPointer *thumbnailPointer =
                [TSAttachmentPointer attachmentPointerFromProto:thumbnailAttachmentProto relay:relay albumMessageId:messageId albumId:thread.uniqueId];
                                                                     ...
                                                                     (SDSAnyWriteTransaction *)transaction
{
    ...
    NSError *error;
    NSArray<TSMessage *> *quotedMessages = (NSArray<TSMessage *> *)[InteractionFinder interactionsWithTimestamp:timestamp
