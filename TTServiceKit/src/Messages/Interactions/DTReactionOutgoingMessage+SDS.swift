...
@objc
public extension DTReactionOutgoingMessage {
    // NOTE: This method will fail if the object has unexpected type.
    class func anyFetchDTReactionOutgoingMessage(
        uniqueId: String,
        transaction: SDSAnyReadTransaction
    ) -> DTReactionOutgoingMessage? {
        ...
        guard let instance = object as? DTReactionOutgoingMessage else {
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateDTReactionOutgoingMessage(transaction: SDSAnyWriteTransaction, block: (DTReactionOutgoingMessage) -> Void) {
...
class DTReactionOutgoingMessageSerializer: SDSSerializer {

    private let model: DTReactionOutgoingMessage
    public required init(model: DTReactionOutgoingMessage) {
        self.model = model
    }
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let recordType: SDSRecordType = .dTReactionOutgoingMessage
