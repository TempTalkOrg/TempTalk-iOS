...
@class DSKProtoDataMessageContact;
@class TSAttachment;
...
/// 联系人
/// @param localContact 列表联系人\可能不在同组
+ (nullable OWSContact *)contactForLocalContact:(nullable Contact *)localContact contactsManager:(id<ContactsManagerProtocol>)contactsManager;
