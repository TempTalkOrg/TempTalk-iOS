...
extension OWSUserProfile {
    ...
    class func fromRecord(_ record: UserProfileRecord) throws -> OWSUserProfile {
        ...
        case .userProfile:
            ...
            let profileKey: SSKAES256Key? = try SDSDeserialization.optionalUnarchive(profileKeySerialized, name: "profileKey")
...
public extension OWSUserProfile {
    ...
    class func anyFetch(uniqueId: String,
        ...
        if !ignoreCache,
            let cachedCopy = Self.modelReadCaches.userProfileReadCache.getUserProfile(address: uniqueId, transaction: transaction) {
            return cachedCopy
        }
...
class OWSUserProfileSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        return UserProfileRecord(delegate: model, id: id, recordType: recordType, uniqueId: uniqueId, avatarFileName: avatarFileName, avatarUrlPath: avatarUrlPath, profileKey: profileKey, profileName: profileName, recipientId: recipientId)
    }
}
