...
public struct MessageContentJobRecord: SDSRecord {
    ...
    public let unsupportedFlag: Bool
    public let lastestHandleVersion: String
...
public extension MessageContentJobRecord {
    ...
    init(row: Row) {
        ...
        envelopeData = row[4]
        plaintextData = row[5]
        unsupportedFlag = row[6]
        lastestHandleVersion = row[7]
    }
}
...
extension OWSMessageContentJob {
    ...
    class func fromRecord(_ record: MessageContentJobRecord) throws -> OWSMessageContentJob {
        ...
        case .messageContentJob:
            ...
            let lastestHandleVersion: String = record.lastestHandleVersion
            let plaintextData: Data? = SDSDeserialization.optionalData(record.plaintextData, name: "plaintextData")
            let unsupportedFlag: Bool = record.unsupportedFlag

            return OWSMessageContentJob(grdbId: recordId,
                                        uniqueId: uniqueId,
                                        createdAt: createdAt,
                                        envelopeData: envelopeData,
                                        lastestHandleVersion: lastestHandleVersion,
...
extension OWSMessageContentJob: DeepCopyable {
    ...
    public func deepCopy() throws -> AnyObject {
        ...
        do {
            ...
            let lastestHandleVersion: String = modelToCopy.lastestHandleVersion
            let plaintextData: Data? = modelToCopy.plaintextData
            let unsupportedFlag: Bool = modelToCopy.unsupportedFlag
...
extension OWSMessageContentJobSerializer {
    ...
    static var unsupportedFlagColumn: SDSColumnMetadata { SDSColumnMetadata(columnName: "unsupportedFlag", columnType: .int) }
    static var lastestHandleVersionColumn: SDSColumnMetadata { SDSColumnMetadata(columnName: "lastestHandleVersion", columnType: .unicodeString) }
    ...
    public static var table: SDSTableMetadata {
        ...
        envelopeDataColumn,
        plaintextDataColumn,
        unsupportedFlagColumn,
        lastestHandleVersionColumn
        ])
    }
}
...
class OWSMessageContentJobSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let unsupportedFlag: Bool = model.unsupportedFlag
        let lastestHandleVersion: String = model.lastestHandleVersion

        return MessageContentJobRecord(delegate: model, id: id, recordType: recordType, uniqueId: uniqueId, createdAt: createdAt, envelopeData: envelopeData, plaintextData: plaintextData, unsupportedFlag: unsupportedFlag, lastestHandleVersion: lastestHandleVersion)
    }
}
