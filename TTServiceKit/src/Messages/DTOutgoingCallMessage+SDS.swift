...
@objc
public extension DTOutgoingCallMessage {
    // NOTE: This method will fail if the object has unexpected type.
    class func anyFetchDTOutgoingCallMessage(
        uniqueId: String,
        transaction: SDSAnyReadTransaction
    ) -> DTOutgoingCallMessage? {
        ...
        guard let instance = object as? DTOutgoingCallMessage else {
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateDTOutgoingCallMessage(transaction: SDSAnyWriteTransaction, block: (DTOutgoingCallMessage) -> Void) {
...
class DTOutgoingCallMessageSerializer: SDSSerializer {

    private let model: DTOutgoingCallMessage
    public required init(model: DTOutgoingCallMessage) {
        self.model = model
    }
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let recordType: SDSRecordType = .dTOutgoingCallMessage
