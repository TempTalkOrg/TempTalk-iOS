...
@objc
public extension DTHyperlinkOutgoingMessage {
    // NOTE: This method will fail if the object has unexpected type.
    class func anyFetchDTHyperlinkOutgoingMessage(
        uniqueId: String,
        transaction: SDSAnyReadTransaction
    ) -> DTHyperlinkOutgoingMessage? {
        ...
        guard let instance = object as? DTHyperlinkOutgoingMessage else {
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateDTHyperlinkOutgoingMessage(transaction: SDSAnyWriteTransaction, block: (DTHyperlinkOutgoingMessage) -> Void) {
...
class DTHyperlinkOutgoingMessageSerializer: SDSSerializer {

    private let model: DTHyperlinkOutgoingMessage
    public required init(model: DTHyperlinkOutgoingMessage) {
        self.model = model
    }
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let recordType: SDSRecordType = .dTHyperlinkOutgoingMessage
