//
//  UIButton+DTAppEnlargeEdge.m
//  TTServiceKit
//
//  Created by hornet on 2022/2/28.
//

#import "UIButton+DTAppEnlargeEdge.h"
#import <objc/runtime.h>

@implementation UIButton (DTAppEnlargeEdge)
...
- (void)setEnlargeEdgeWithTop:(CGFloat) top right:(CGFloat)right bottom:(CGFloat)bottom left:(CGFloat)left{
    [self dtApp_setEnlargeEdgeWithTop:top right:right bottom:bottom left:left];
}
@end
