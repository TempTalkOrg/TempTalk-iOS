...
//      "Wea/2.4.2 (iPhone; iOS 13.5.1; Scale/2.0)"
//      "Wea/2.3.9 (iPhone; iOS 15.5; Scale/3.00)"
        //  ua
        TSConstants.appUserAgent
    }
    ...
    // basic auth
    @objc
    public static var loginHeaderKey: String { "login" }
    
    @objc
    public static var loginHeaderValue: String { tsAccountManager.localNumber() ?? "" }
    
    @objc
    public static var passwordHeaderKey: String { "password" }
    
    @objc
    public static var passwordHeaderValue: String { tsAccountManager.serverAuthToken() ?? "" }
    ...
    // wss://wea.chat.difft.org/chat/v1/websocket/?login=xxx&password=xxx
    // wss://wea.chat.difft.org/chat/v1/websocket/ header "Authorization" = "Basic " + data.base64EncodedString()
    // abc:123456
    @objc
