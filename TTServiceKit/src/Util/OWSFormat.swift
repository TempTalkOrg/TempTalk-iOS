...
public extension OWSFormat {
    ...
    static func formatFileSize(_ fileSize: UInt) -> String {
        ...
        if fileSize > kOneGigabyte * 1 {
            ...
            let kbSize = max(Double(0), Double(fileSize) / Double(kOneKilobyte))
    ...
    class func formatNSIntMax99(_ value: NSNumber) -> String {
    ...
    class func formatIntMax99(_ value: Int) -> String {
        
        return formatNSIntMax99(NSNumber(value: value))
    }
}
