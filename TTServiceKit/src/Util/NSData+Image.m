...
- (BOOL)ows_isValidMimeType:(nullable NSString *)mimeType imageFormat:(ImageFormat)imageFormat
{
    ...
    switch (imageFormat) {
        ...
        case ImageFormat_Png:
            return (mimeType == nil || 
                    [mimeType caseInsensitiveCompare:OWSMimeTypeImagePng] == NSOrderedSame ||
                    ...
                    [mimeType caseInsensitiveCompare:OWSMimeTypeImageJpeg] == NSOrderedSame);
        case ImageFormat_Gif:
            return (
                mimeType == nil || [mimeType caseInsensitiveCompare:OWSMimeTypeImageGif] == NSOrderedSame);
        case ImageFormat_Tiff:
            return (mimeType == nil ||
                [mimeType caseInsensitiveCompare:OWSMimeTypeImageTiff1] == NSOrderedSame ||
                [mimeType caseInsensitiveCompare:OWSMimeTypeImageTiff2] == NSOrderedSame);
        case ImageFormat_Jpeg:
            //MARK:mimeType和获取到的图片类型不一致
            return (mimeType == nil ||
                    [mimeType caseInsensitiveCompare:OWSMimeTypeImageJpeg] == NSOrderedSame ||
                    [mimeType caseInsensitiveCompare:OWSMimeTypeImagePng] == NSOrderedSame);
        case ImageFormat_Bmp:
        ...
        case ImageFormat_Webp:
            return (
                mimeType == nil || [mimeType caseInsensitiveCompare:OWSMimeTypeImageWebp] == NSOrderedSame);
        case ImageFormat_Heic:
            return (
                mimeType == nil || [mimeType caseInsensitiveCompare:OWSMimeTypeImageHeic] == NSOrderedSame);
        case ImageFormat_Heif:
            return (
                mimeType == nil || [mimeType caseInsensitiveCompare:OWSMimeTypeImageHeif] == NSOrderedSame);
        case ImageFormat_LottieSticker:
            if (!SSKFeatureFlags.supportAnimatedStickers_Lottie) {
                return false;
            }
            return (mimeType == nil ||
                [mimeType caseInsensitiveCompare:OWSMimeTypeLottieSticker] == NSOrderedSame);
    }
}
                          ...
                          ignoreFileSize:(BOOL)ignoreFileSize
{
    BOOL canBeLottieSticker
        = (declaredMimeType != nil && [OWSMimeTypeLottieSticker isEqualToString:declaredMimeType]);
