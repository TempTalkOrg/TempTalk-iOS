...
// TTServiceKit/Utilities/extract_analytics_event_names.py
...
+ (NSString *)messageReceivedAnInvalidMessage{
    return @"received_an_invalid_message";
}

+ (NSString *)messageDecryptedPayloadError{
    return @"decrypted_payload_error";
}

+ (NSString *)messageReceivedAnInvalidEnvelope{
    return @"received_an_invalid_envelope";
}

+ (NSString *)messageReceivedAnInvalidConversation{
    return @"received_an_invalid_conversation";
}

+ (NSString *)messageCouldNotParseProto{
    return @"could_not_parse_proto";
}

+ (NSString *)messageUnknownSource{
    return @"unknown_source";
}

+ (NSString *)messageUnknownType{
    return @"unknown_Type";
}

+ (NSString *)messageIgnoringBlockedEnvelope{
    return @"ignoring_blocked_envelope";
}

+ (NSString *)messageProcessEnvelope{
    return @"process_envelope";
}

+ (NSString *)messageIncomingEnvelopeHasInvalidSource{
    return @"incoming_envelope_has_invalid_source";
}

+ (NSString *)messageMissingDecryptedDataForEnvelope{
    return @"missing_decrypted_data_for_envelope";
}

+ (NSString *)messageMissingGroupUpdateDataForEnvelope{
    return @"missing_group_update_data_for_envelope";
}

+ (NSString *)messageDuplicateEnvelope{
...
+ (NSString *)storageErrorSerialization
{
    return @"storage_error_serialization";
}
