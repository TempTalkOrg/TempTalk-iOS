                               ...
                               passcode:(nullable NSString *)passcode
{
    ...
    NSURL *url =
        [NSURL URLWithString:[NSString stringWithFormat:@"%@/code/%@", @"v1/accounts", verificationCode]];
    NSDictionary *parameters =
        [TSAttributes attributesWithSignalingKey:signalingKey serverAuthToken:authKey manualMessageFetching:NO pin:pin passcode:passcode];
