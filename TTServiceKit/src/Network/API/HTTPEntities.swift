...
public enum OWSHTTPError: Error, IsRetryableProvider, UserErrorDescriptionProvider {
    ...
    public var localizedDescription: String {
        ...
        case .missingRequest, .invalidAppState, .invalidRequest, .networkFailure:
            return Localized("ERROR_DESCRIPTION_REQUEST_FAILED", comment: "Error indicating that a socket request failed.")
        case .invalidResponse, .serviceResponse:
            return Localized("ERROR_DESCRIPTION_RESPONSE_FAILED", comment: "Error indicating that a socket response failed.")
        }
    }
...
extension OWSHTTPError: CustomNSError {
    ...
    public var asConnectionFailureError: OWSHTTPErrorWrapper {
        let newError = OWSHTTPError.forServiceResponse(requestUrl: error.requestUrl,
                                                       ...
                                                       customLocalizedDescription: OWSLocalizedString("ERROR_DESCRIPTION_NO_INTERNET",
                                                                                                     comment: "Generic error used whenever Wea can't contact the server"),
