...
@interface NSObject (SignalYYModel)
/**
 ...
 */
+ (nullable instancetype)signal_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)signal_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)signal_modelToJSONObject;
 ...
 */
- (nullable NSData *)signal_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)signal_modelToJSONString;
 ...
 */
@interface NSArray (SignalYYModel)
 ...
 */
+ (nullable NSArray *)signal_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (SignalYYModel)
 ...
 */
+ (nullable NSDictionary *)signal_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<SignalYYModel>' to your class header.
 */
@protocol SignalYYModel <NSObject>
@optional
...
/**
 ...
 Example:
    ...
    model:
    @code
        @interface signalYYBook : NSObject
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class signalYYShadow, signalYYBorder, signalYYAttachment;
 
        @interface signalYYAttributes
        @property NSString *name;
        ...
        @implementation signalYYAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [signalYYShadow class],
                     @"borders" : signalYYBorder.class,
                     @"attachments" : @"signalYYAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class signalYYCircle, signalYYRectangle, signalYYLine;
 
        @implementation signalYYShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [signalYYCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [signalYYRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [signalYYLine class];
            } else {
                return [self class];
            }
        }
