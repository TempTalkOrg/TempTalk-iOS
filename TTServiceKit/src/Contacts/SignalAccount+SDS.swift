...
public struct SignalAccountRecord: SDSRecord {
    ...
    public let isManualEdited: Bool
...
extension SignalAccount {
    ...
    class func fromRecord(_ record: SignalAccountRecord) throws -> SignalAccount {
        ...
        case .signalAccount:
            ...
            let isManualEdited: Bool = record.isManualEdited
...
extension SignalAccount: DeepCopyable {
    ...
    public func deepCopy() throws -> AnyObject {
        ...
        do {
            ...
            let hasMultipleAccountContact: Bool = modelToCopy.hasMultipleAccountContact
            let isManualEdited: Bool = modelToCopy.isManualEdited
...
extension SignalAccountSerializer {
    ...
    static var hasMultipleAccountContactColumn: SDSColumnMetadata { SDSColumnMetadata(columnName: "hasMultipleAccountContact", columnType: .int) }
    static var isManualEditedColumn: SDSColumnMetadata { SDSColumnMetadata(columnName: "isManualEdited", columnType: .int) }
    ...
    static var remarkNameColumn: SDSColumnMetadata { SDSColumnMetadata(columnName: "remarkName", columnType: .unicodeString, isOptional: true) }
...
public extension SignalAccount {
    ...
    class func anyFetch(uniqueId: String,
        ...
        if !ignoreCache,
            let cachedCopy = Self.modelReadCaches.signalAccountReadCache.getSignalAccount(address: uniqueId, transaction: transaction) {
            return cachedCopy
        }
...
class SignalAccountSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let isManualEdited: Bool = model.isManualEdited
        ...
        return SignalAccountRecord(delegate: model, id: id, recordType: recordType, uniqueId: uniqueId, contact: contact, hasMultipleAccountContact: hasMultipleAccountContact, isManualEdited: isManualEdited, multipleAccountLabelText: multipleAccountLabelText, recipientId: recipientId, remarkName: remarkName)
    }
}
