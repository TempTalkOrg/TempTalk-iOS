...
public extension SignalRecipient {
    ...
    class func anyFetch(uniqueId: String,
        ...
        if !ignoreCache,
            let cachedCopy = Self.modelReadCaches.signalRecipientReadCache.getSignalRecipient(address: uniqueId, transaction: transaction) {
            return cachedCopy
        }
...
class SignalRecipientSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        return SignalRecipientRecord(delegate: model, id: id, recordType: recordType, uniqueId: uniqueId, devices: devices, relay: relay)
    }
}
