...
//
// Ported verbatim from Signal-iOS @ ad9893d
// (SignalServiceKit/Storage/Database/SDSCodableModel/InheritableRecord.swift)
// No fork-specific adaptation is needed — this protocol depends only on Foundation
// and Swift's Decodable.
//
...
public protocol InheritableRecord: Decodable {
