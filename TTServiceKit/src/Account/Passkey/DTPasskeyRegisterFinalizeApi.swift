...
import Foundation
@objc
public class DTPasskeyRegisterFinalizeApi : DTBaseAPI {
    ...
    public override var requestUrl: String {
        get {
            return "/v3/webauthn/registration/finalize";
        }
        set{
    ...
    func registerFinalizeForPasskeys(_ parms: [String : Any], sucess:  @escaping((DTAPIMetaEntity?) -> Void), failure:((Error, DTAPIMetaEntity?) -> Void)? = nil)  {
