...
import Foundation
@objc
public class DTPasskeyForLoginFinalizeApi : DTBaseAPI {
    ...
    public override var requestUrl: String {
        get {
            return "/v3/webauthn/login/finalize";
        }
        set{
    ...
    @objc
    func loginFinalizeForPasskeys(_ parms: [String : Any], sucess: @escaping((DTAPIMetaEntity?) -> Void), failure:((Error, DTAPIMetaEntity?) -> Void)? = nil)  {
