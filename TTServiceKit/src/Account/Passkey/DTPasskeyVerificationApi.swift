//
//  DTasskeyAuthApi.swift
//  TTServiceKit
//
//  Created by hornet on 2023/7/24.
//

import Foundation

@objc
public class DTPasskeyVerificationApi : DTBaseAPI {
    ...
    public override var requestUrl: String {
        get {
            return "/v2/auth/login/webauthn/verification";
        }
        set{
    ...
    @objc
    func loginVerificationForPasskeys(sucess: @escaping((DTAPIMetaEntity?) -> Void), failure:((Error, DTAPIMetaEntity?) -> Void)? = nil) {
