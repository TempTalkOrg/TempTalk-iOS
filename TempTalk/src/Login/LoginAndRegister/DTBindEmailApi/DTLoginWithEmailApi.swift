...
import Foundation
@objc
public class DTLoginWithEmailApi : DTBaseAPI {
    ...
    @objc
    func login(_ email: String, sucess: @escaping RESTNetworkManagerSuccess, failure:((Error, DTAPIMetaEntity?) -> Void)? = nil)  {
        let parms: [String : String] = ["email":email]
