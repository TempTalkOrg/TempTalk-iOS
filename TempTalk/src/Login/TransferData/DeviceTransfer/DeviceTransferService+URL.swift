...
@objcMembers class DeviceTransferURLComponent: NSObject {
    public let peerId: MCPeerID
    public let certificateHash: Data
   
    init(peerId: MCPeerID, certificateHash: Data) {
        self.peerId = peerId
...
extension DeviceTransferService {
    ...
    @objc
    func parseTransferURL(_ url: URL) throws -> DeviceTransferURLComponent {
        ...
        let currentMode: TransferMode = .primary
        ...
        return .init(peerId: peerId, certificateHash: certificateHash)
    }
}
