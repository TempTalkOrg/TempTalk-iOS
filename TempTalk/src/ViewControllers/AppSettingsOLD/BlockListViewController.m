...
- (void)loadView
{
    ...
    self.title
        = Localized(@"SETTINGS_BLOCK_LIST_TITLE", @"Label for the block list section of the settings view");
...
- (void)updateTableContents
{
    ...
    addSection.footerTitle = Localized(
        @"BLOCK_BEHAVIOR_EXPLANATION", @"An explanation of the consequences of blocking another user.");

    [addSection
        addItem:[OWSTableItem
                    disclosureItemWithText:Localized(@"SETTINGS_BLOCK_LIST_ADD_BUTTON",
