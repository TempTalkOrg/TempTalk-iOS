...
+ (void)presentFromViewController:(UIViewController *)viewController recipientId:(NSString *)recipientId
{
    ...
    if (!recipientIdentity) {
        [OWSAlerts showAlertWithTitle:Localized(@"CANT_VERIFY_IDENTITY_ALERT_TITLE",
                                          @"Title for alert explaining that a user cannot be verified.")
                              message:Localized(@"CANT_VERIFY_IDENTITY_ALERT_MESSAGE",
...
- (void)loadView
{
    ...
    self.title = Localized(@"PRIVACY_VERIFICATION_TITLE", @"Navbar title");
...
- (void)createViews
{
    ...
    [verifyUnverifyButton autoPinEdgeToSuperviewSafeArea:ALEdgeBottom];
    ...
    // Instructions
    NSString *instructionsFormat = Localized(@"PRIVACY_VERIFICATION_INSTRUCTIONS",
    ...
    [verificationStateLabel autoPinEdgeToSuperviewSafeArea:ALEdgeTop withInset:ScaleFromIPhone5To7Plus(15.f, 20.f)];
...
- (void)updateVerificationStateLabel
{
    ...
    if (isVerified) {
        ...
        [labelText
            appendAttributedString:
                [[NSAttributedString alloc]
                    initWithString:[NSString stringWithFormat:Localized(@"PRIVACY_IDENTITY_IS_VERIFIED_FORMAT",
        ...
        self.verifyUnverifyButtonLabel.text = Localized(
        ...
        self.verificationStateLabel.text = [NSString
            stringWithFormat:Localized(@"PRIVACY_IDENTITY_IS_NOT_VERIFIED_FORMAT",
        ...
        [buttonText appendAttributedString:
                        [[NSAttributedString alloc]
                            initWithString:Localized(@"PRIVACY_VERIFY_BUTTON",
...
- (void)showSharingActivityWithCompletion:(nullable void (^)(void))completionHandler
{
    ...
    NSString *shareFormat = Localized(
