...
- (void)loadView
{
    ...
    self.title = Localized(@"SCAN_QR_CODE_VIEW_TITLE", @"Title for the 'scan QR code' view.");
...
- (void)createViews
{
    ...
    [self.qrScanningController.view autoPinEdgeToSuperviewSafeArea:ALEdgeTop];
    ...
    cameraInstructionLabel.text
        = Localized(@"SCAN_CODE_INSTRUCTIONS", @"label presented once scanning (camera) view is visible.");
    ...
    [cameraInstructionLabel autoPinEdgeToSuperviewSafeArea:ALEdgeBottom withInset:instructionsVMargin];
                              ...
                              tag:(NSString *)tag
{
    ...
    NSString *successTitle = Localized(@"SUCCESSFUL_VERIFICATION_TITLE", nil);
    NSString *descriptionFormat = Localized(
    ...
    [alertController
        addAction:[UIAlertAction
                      actionWithTitle:Localized(@"FINGERPRINT_SCAN_VERIFY_BUTTON",
                              ...
                              handler:^(UIAlertAction *action) {
                                  [OWSIdentityManager.sharedManager setVerificationState:OWSVerificationStateVerified
                                                                   ...
                                                                   isUserInitiatedChange:YES isSendSystemMessage:YES];
                                    ...
                                    tag:(NSString *)tag
{
    ...
    if (error.code != OWSErrorCodeUserError) {
        failureTitle = Localized(@"FAILED_VERIFICATION_TITLE", @"alert title");
