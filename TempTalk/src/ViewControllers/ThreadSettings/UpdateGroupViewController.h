...
//    UpdateGroupMode_EditGroupMembers,
//    UpdateGroupMode_AddGroupMembers,
    UpdateGroupMode_RemoveGroupMembers,
};
...
@property (nonatomic, copy) void (^removeGroupMemberFinished)(void);
