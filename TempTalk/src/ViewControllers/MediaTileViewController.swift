...
public class MediaTileViewController: UICollectionViewController, MediaGalleryDataSourceDelegate {
    ...
    override public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let galleryCell = self.collectionView.cellForItem(at: indexPath) as? MediaGalleryCell else {
    ...
    override public func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        guard galleryDates.count > 0 else {
            ...
            let title = Localized("GALLERY_TILES_EMPTY_GALLERY", comment: "Label indicating media gallery is empty")
        ...
        if (kind == UICollectionView.elementKindSectionHeader) {
            ...
            case kLoadOlderSectionIdx:
                ...
                let title = Localized("GALLERY_TILES_LOADING_OLDER_LABEL", comment: "Label indicating loading is in progress")
                sectionHeader.configure(title: title)
                return sectionHeader
            case loadNewerSectionIdx:
                ...
                let title = Localized("GALLERY_TILES_LOADING_MORE_RECENT_LABEL", comment: "Label indicating loading is in progress")
                sectionHeader.configure(title: title)
                return sectionHeader
            default:
    ...
    func updateSelectButton() {
        if isInBatchSelectMode {
            ...
            self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: Localized("BUTTON_SELECT", comment: "Button text to enable batch selection mode"),
                                                                     style: .plain,
                                                                     target: self,
    ...
    func didPressDelete(_ sender: Any) {
        ...
        let confirmationTitle: String = {
            if indexPaths.count == 1 {
                return Localized("MEDIA_GALLERY_DELETE_SINGLE_MESSAGE", comment: "Confirmation button text to delete selected media message from the gallery")
            } else {
                let format = Localized("MEDIA_GALLERY_DELETE_MULTIPLE_MESSAGES_FORMAT", comment: "Confirmation button text to delete selected media from the gallery, embeds {{number of messages}}")
    ...
    func mediaGalleryDataSource(_ mediaGalleryDataSource: MediaGalleryDataSource, deletedSections: IndexSet, deletedItems: [IndexPath]) {
        ...
        guard mediaGalleryDataSource.galleryItemCount == deletedItems.count else {
            // Show Empty
...
extension MediaTileViewController : OWSNavigationChildController {
