...
const CGFloat kOWSMessageCellCornerRadius_Large = 5;
const CGFloat kOWSMessageCellCornerRadius_Small = 5;
...
{
    // fix: 循环引用 layoutIfNeeded->setBunds->layoutIfNeeded
//    [self layoutIfNeeded];
