...
//    id <DataSource> _Nullable dataSource = [DataSourcePath dataSourceWithFilePath:filePath shouldDeleteOnDeallocation:NO error:nil];
...
//                [DDLog flushLog];
//                ConversationInteractionViewItem *viewItem = [[ConversationInteractionViewItem alloc] initWithInteraction:messageToQuote
//                                                                                                                  thread:thread
//                                                                                                             transaction:transaction.asAnyRead
//                                                                                                       conversationStyle:conversationStyle];
//                quotedMessage = (TSQuotedMessage *) [[OWSQuotedReplyModel replyModelForConversationViewItem:viewItem transaction:transaction] buildMessage];
//            } else {
...
//}
//
//+ (DSKProtoEnvelope *)createEnvelopeForThread:(TSThread *)thread
//{
//    OWSAssertDebug(thread);
//
...
//
//                  TSContactThread *contactThread = [TSContactThread getOrCreateThreadWithContactId:phoneNumberText];
...
//        [[TSGroupModel alloc] initWithTitle:groupName memberIds:recipientIds image:nil groupId:groupId groupOwner:nil groupAdmin:nil];
//
...
//    NSString *text = [[[@(counter) description] stringByAppendingString:@" "] stringByAppendingString:randomText];
//
//    DSKProtoDataMessageBuilder *dataMessageBuilder = [DSKProtoDataMessage builder];
...
//    }
//
//    DSKProtoContentBuilder *payloadBuilder = [DSKProtoContent builder];
...
//    }
//
//    DSKProtoEnvelopeBuilder *envelopeBuilder = [DSKProtoEnvelope builder];
//    [envelopeBuilder setType:DSKProtoEnvelopeTypeCiphertext];
...
//
//    // TODO: MessageProcessor 构建 EncryptedEnvelope 加入 PendingEnvelops
...
//                [message updateWithSentRecipient:recipientId serverReceipts:nil transaction:transaction];
...
//
//    if (isAttachmentDownloaded) {
//        id <DataSource> dataSource = [DataSourcePath dataSourceWithFilePath:fakeAssetLoader.filePath shouldDeleteOnDeallocation:NO error:nil];
