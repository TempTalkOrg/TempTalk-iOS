...
@objc
protocol MessageActionsViewControllerDelegate: AnyObject {
...
//        let picker = MessageReactionPicker(selectedEmoji: focusedViewItem.reactionState?.localUserEmoji, delegate: self)
        let picker = MessageReactionPicker(selectedEmoji: nil, delegate: self)
        ...
        picker.autoPinEdge(ALEdge.leading, to: ALEdge.leading, of: view, withOffset: pickerOrigin.x)
        picker.autoPinEdge(ALEdge.top, to: ALEdge.top, of: view, withOffset: pickerOrigin.y)
...
private protocol MessageActionsToolbarDelegate: AnyObject {
