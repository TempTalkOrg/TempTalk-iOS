...
- (void)showChangeAvatarUI
{
    ...
    UIAlertAction *takePictureAction = [UIAlertAction
        actionWithTitle:Localized(@"MEDIA_FROM_CAMERA_BUTTON", @"media picker option to take photo or video")
    ...
    UIAlertAction *choosePictureAction = [UIAlertAction
        actionWithTitle:Localized(@"MEDIA_FROM_LIBRARY_BUTTON", @"media picker option to choose from library")
                  style:UIAlertActionStyleDefault
                handler:^(UIAlertAction *_Nonnull action) {
