...
public class ActionSheetController: OWSViewController {
    ...
    private weak var stackHeader: UIStackView?
    ...
    @objc
    public var messageAlignment: ContentAlignment = .center {
        didSet {
            guard oldValue != messageAlignment else { return }
            ...
            case .trailing:
                lbMessage?.textAlignment = .trailing
            }
        }
    }
    ...
    public func addAction(_ action: ActionSheetAction) {
        ...
        action.isDarkThemeOnly = isDarkThemeOnly
    ...
    override public func loadView() {
        ...
        safeAreaBackdrop.backgroundColor = backgroundColor()
    ...
    func createHeader(title: String? = nil, message: String? = nil) {
        ...
        stackHeader = headerStack
        headerStack.backgroundColor = backgroundColor()
...
public class ActionSheetAction: NSObject {
    ...
    public var titleColor: UIColor? {
        didSet {
            button.setTitleColor(titleColor, for: .init())
        }
    }
    @objc
    ...
    fileprivate class Button: UIButton {
        ...
        private var isDarkThemeOnly = false
        ...
        init(action: ActionSheetAction) {
            ...
            case .default:
                ...
                setTitleColor(primaryTextColor, for: .init())
            case .cancel:
