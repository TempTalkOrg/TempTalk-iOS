...
public class EditContactShareNameViewController: OWSViewController, ContactNameFieldViewDelegate {
    ...
    override public func loadView() {
        ...
        self.navigationItem.title = Localized("CONTACT_SHARE_EDIT_NAME_VIEW_TITLE",
    ...
    private func updateContent() {
        ...
        scrollView.autoPinEdge(toSuperviewSafeArea: ALEdge.top)
