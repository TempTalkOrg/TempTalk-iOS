...
@objc
public protocol ReturnToCallViewControllerDelegate: AnyObject {
...
public class ReturnToCallViewController: UIViewController {
    ...
    override public func loadView() {
        ...
        returnToCallLabel.text = Localized("CALL_WINDOW_RETURN_TO_CALL", comment: "Label for the 'return to call' banner.")
