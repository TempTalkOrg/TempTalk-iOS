...
public extension UINavigationController {
    ...
    @objc func popToViewController(_ viewController: UIViewController,
                             animated: Bool,
                             completion: (() -> Void)?) {
        CATransaction.begin()
        CATransaction.setCompletionBlock(completion)
...
//    func removeToViewController(_ targetClass: AnyClass?) {
//        guard let targetClass = targetClass else { return }
//        
//        Logger.debug("Navigation remove to \(targetClass)")
//        
//        var indexOfController: Int? = nil
//        
//        for (idx, viewController) in viewControllers.enumerated() {
//            if type(of: viewController) == targetClass {
//                indexOfController = idx
//                break
//            }
//        }
//        
//        if let index = indexOfController,
//           index >= 0,
//           index < viewControllers.count - 1,
//           viewControllers.count >= 3 {
//            
//            let length = viewControllers.count - (index + 1) - 1
//            guard length > 0 else { return }
//            
//            var tempControllers = viewControllers
//            tempControllers.removeSubrange((index + 1)..<(index + 1 + length))
//            self.viewControllers = tempControllers
//        }
//    }
    
    func removeViewController(ofType targetClass: AnyClass) {
        let filteredViewControllers = viewControllers.filter { type(of: $0) != targetClass }
        self.viewControllers = filteredViewControllers
    }
