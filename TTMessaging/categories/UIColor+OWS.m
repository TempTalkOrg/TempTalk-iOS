...
+ (UIColor *)ows_translateLightGrayColor
{
    return [UIColor colorWithHue:240.0f / 360.0f saturation:0.02f brightness:0.92f alpha:0.5f];
}
...
{
    CGFloat r0, g0, b0, a0;
    BOOL result = [self getRed:&r0 green:&g0 blue:&b0 alpha:&a0];
    OWSAssertDebug(result);

    CGFloat r1, g1, b1, a1;
    result = [otherColor getRed:&r1 green:&g1 blue:&b1 alpha:&a1];
    OWSAssertDebug(result);
...
+ (UIColor *)ows_light45WithAlphaColor
{
    return [UIColor colorWithRGBHex:0x8B8E91 ];
}
...
{ //0x2e7d32
    return [UIColor colorWithRGBHex:0x01BC6A];
}
...
+ (UIColor *)ows_black01Color
{
    return [UIColor colorWithRGBHex:0x333333];
}

+ (UIColor *)ows_lightGray01Color
{
    return [UIColor colorWithRGBHex:0x8d8e90];
}

+ (UIColor *)ows_lightGray02Color
{
    return [UIColor colorWithRGBHex:0xc7c9c8];
}

+ (UIColor *)ows_lightGray03Color
{
    return [UIColor colorWithRGBHex:0xf2f2f2];
}
...
+ (UIColor *)ows_darkSkyBlueWithAlphaColor
{
    return [UIColor colorWithRed:32.f / 255.f green:144.f / 255.f blue:234.f / 255.f alpha:.5];
}

+ (UIColor *)ows_darkSkyBlueTranslateColor
{
    return [UIColor colorWithRGBHex:0x2090EA];
}


+ (UIColor *)ows_avatarColor1
{
    return [UIColor colorWithR:255 G:69 B:58 a:1];
}

+ (UIColor *)ows_avatarColor2
{
    return [UIColor colorWithR:255 G:159 B:11 a:1];
}

+ (UIColor *)ows_avatarColor3
{
    return [UIColor colorWithR:254 G:215 B:9 a:1];
}

+ (UIColor *)ows_avatarColor4
{
    return [UIColor colorWithR:49 G:209 B:91 a:1];
}

+ (UIColor *)ows_avatarColor5
{
    return [UIColor colorWithR:120 G:195 B:255 a:1];
}

+ (UIColor *)ows_avatarColor6
{
    return [UIColor colorWithR:11 G:132 B:255 a:1];
}

+ (UIColor *)ows_avatarColor7
{
    return [UIColor colorWithR:94 G:92 B:230 a:1];
}

+ (UIColor *)ows_avatarColor8
{
    return [UIColor colorWithR:213 G:127 B:245 a:1];
}

+ (UIColor *)ows_avatarColor9
{
    return [UIColor colorWithR:114 G:126 B:135 a:1];
}

+ (UIColor *)ows_avatarColor10
{
    return [UIColor colorWithR:235 G:79 B:121 a:1];
}




+ (UIColor *)ows_ThreadColor1
{
    return [UIColor colorWithR:235 G:69 B:58 a:1];
}

+ (UIColor *)ows_ThreadColor2
{
    return [UIColor colorWithR:235 G:159 B:11 a:1];
}

+ (UIColor *)ows_ThreadColor3
{
    return [UIColor colorWithR:234 G:215 B:9 a:1];
}

+ (UIColor *)ows_ThreadColor4
{
    return [UIColor colorWithR:49 G:189 B:91 a:1];
}

+ (UIColor *)ows_ThreadColor5
{
    return [UIColor colorWithR:120 G:195 B:235 a:1];
}

+ (UIColor *)ows_ThreadColor6
{
    return [UIColor colorWithR:11 G:132 B:235 a:1];
}

+ (UIColor *)ows_ThreadColor7
{
    return [UIColor colorWithR:94 G:92 B:210 a:1];
}

+ (UIColor *)ows_ThreadColor8
{
    return [UIColor colorWithR:213 G:127 B:225 a:1];
}

+ (UIColor *)ows_ThreadColor9
{
    return [UIColor colorWithR:114 G:126 B:115 a:1];
}

+ (UIColor *)ows_ThreadColor10
{
    return [UIColor colorWithR:235 G:79 B:121 a:1];
}
...
+ (NSDictionary<NSString *, UIColor *> *)ows_conversationColorMap
{
    ...
    dispatch_once(&onceToken, ^{
        colorMap = @{
            @"color1": self.ows_avatarColor1,
            @"color2": self.ows_avatarColor2,
            @"color3": self.ows_avatarColor3,
            @"color4": self.ows_avatarColor4,
            @"color5": self.ows_avatarColor5,
            @"color6": self.ows_avatarColor6,
            @"color7": self.ows_avatarColor7,
            @"color8": self.ows_avatarColor8,
            @"color9": self.ows_avatarColor9,
            @"color10": self.ows_avatarColor10,
        };
    });
...
+ (nullable UIColor *)ows_conversationThreadColorForColorName:(NSString *)colorName
{
    OWSAssertDebug(colorName.length > 0);
    
    return [self.ows_conversationThreadColorMap objectForKey:colorName];
}
+ (NSDictionary<NSString *, UIColor *> *)ows_conversationThreadColorMap
{
    static NSDictionary<NSString *, UIColor *> *colorMap;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        colorMap = @{
            @"color1": self.ows_ThreadColor1,
            @"color2": self.ows_ThreadColor2,
            @"color3": self.ows_ThreadColor3,
            @"color4": self.ows_ThreadColor4,
            @"color5": self.ows_ThreadColor5,
            @"color6": self.ows_ThreadColor6,
            @"color7": self.ows_ThreadColor7,
            @"color8": self.ows_ThreadColor8,
            @"color9": self.ows_ThreadColor9,
            @"color10": self.ows_ThreadColor10,
        };
    });
...
+ (UIColor *)ows_cellSeparatorColor
{
