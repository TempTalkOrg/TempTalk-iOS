...
- (void)setContentHuggingMedium {
    [self setContentHuggingHorizontalMedium];
    [self setContentHuggingVerticalMedium];
}
...
- (void)setContentHuggingHorizontalMedium {
    [self setContentHuggingPriority:500 forAxis:UILayoutConstraintAxisHorizontal];
}
...
- (void)setContentHuggingVerticalMedium {
    [self setContentHuggingPriority:500 forAxis:UILayoutConstraintAxisVertical];
}
...
- (void)setCompressionResistanceMedium {
    [self setCompressionResistanceHorizontalMedium];
    [self setCompressionResistanceVerticalMedium];
}
...
- (void)setCompressionResistanceVerticalMedium {
    [self setContentCompressionResistancePriority:500 forAxis:UILayoutConstraintAxisVertical];
}
