...
@property (class, readonly, nonatomic) UIColor *ows_translateLightGrayColor;
...
@property (class, readonly, nonatomic) UIColor *ows_darkSkyBlueWithAlphaColor;

@property (class, readonly, nonatomic) UIColor *ows_darkSkyBlueTranslateColor;
@property (class, readonly, nonatomic) UIColor *ows_black01Color;
@property (class, readonly, nonatomic) UIColor *ows_lightGray01Color;
@property (class, readonly, nonatomic) UIColor *ows_lightGray02Color;
@property (class, readonly, nonatomic) UIColor *ows_lightGray03Color;
