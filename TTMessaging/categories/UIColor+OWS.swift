...
//    @objc(colorWithRGBHex:)
    ...
    class func color(rgbHex: UInt, alpha: CGFloat) -> UIColor {
        return UIColor(rgbHex: rgbHex ,alpha: alpha)
    }

    convenience init(rgbHex value: UInt, alpha: CGFloat) {
        let red = CGFloat(((value >> 16) & 0xff)) / 255.0
        let green = CGFloat(((value >> 8) & 0xff)) / 255.0
        let blue = CGFloat(((value >> 0) & 0xff)) / 255.0
...
public extension UIColor {
    ...
    @objc(ows_alertConfirmDarkBlueColor)
    class var ows_alertConfirmDarkBlue: UIColor {
        return UIColor(rgbHex: 0x4DA0FF)
    }
    
    @objc(ows_alertConfirmLightBlueColor)
    class var ows_alertConfirmLightBlue: UIColor {
        return UIColor(rgbHex: 0x056FFA)
    }
    
    @objc(ows_alertCancelDarkColor)
    class var ows_alertCancelDark: UIColor {
        return UIColor(rgbHex: 0xEAECEF)
    }
    
    @objc(ows_alertCancelLightColor)
    class var ows_alertCancelLight: UIColor {
        return UIColor(rgbHex: 0x1E2329)
    }
    ...
    class var ows_gray45: UIColor {
        return UIColor(rgbHex: 0x848E9C)
    }
    ...
    @objc(ows_gray181818Color)
    class var ows_gray181818: UIColor {
        return UIColor(rgbHex: 0x181818)
    }
    ...
    @objc(ows_themeBlueColor)
    class var ows_themeBlue: UIColor {
        return UIColor(rgbHex: 0x056FFA)
    }
    
    @objc(ows_themeBlueDarkColor)
    class var ows_themeBlueDark: UIColor {
        return UIColor(rgbHex: 0x4DA0FF)
    }
    
    @objc(ows_themeBlueDark2Color)
    class var ows_themeBlueDark2: UIColor {
        return UIColor(rgbHex: 0x82C1FC)
    }
    
    @objc(ows_tabbarNormalColor)
    class var ows_tabbarNormal: UIColor {
        return UIColor(rgbHex: 0x474D57)
    }
    
    @objc(ows_tabbarNormalDarkColor)
    class var ows_tabbarNormalDark: UIColor {
        return UIColor(rgbHex: 0xB7BDC6)
    }
    ...
    class var mergedTintColors: [UIColor] {
        return [
            UIColor(rgbHex: 0x016DC0),
            UIColor(rgbHex: 0x009659),
            UIColor(rgbHex: 0x8E3DEB),
            UIColor(rgbHex: 0xDA9900),
            UIColor(rgbHex: 0x474D57),
            UIColor(rgbHex: 0x099996),
            UIColor(rgbHex: 0xD9271E),
            UIColor(rgbHex: 0x003366),
            UIColor(rgbHex: 0x00563A),
            UIColor(rgbHex: 0xCE0857),
            UIColor(rgbHex: 0x8A5000),
            UIColor(rgbHex: 0xA71914),
            UIColor(rgbHex: 0x461585),
            UIColor(rgbHex: 0x173536),
            UIColor(rgbHex: 0x700831),
        ]
    }
