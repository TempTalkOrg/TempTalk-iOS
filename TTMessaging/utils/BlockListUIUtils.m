                         ...
                         completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    for (NSString *phoneNumber in phoneNumbers) {
        ...
        if ([localContactId isEqualToString:phoneNumber]) {
            [self showOkAlertWithTitle:Localized(@"BLOCK_LIST_VIEW_CANT_BLOCK_SELF_ALERT_TITLE",
                                           @"The title of the 'You can't block yourself' alert.")
                               message:Localized(@"BLOCK_LIST_VIEW_CANT_BLOCK_SELF_ALERT_MESSAGE",
    ...
    NSString *title = [NSString stringWithFormat:Localized(@"BLOCK_LIST_BLOCK_TITLE_FORMAT",
    ...
    UIAlertController *actionSheetController =
        [UIAlertController alertControllerWithTitle:title
                                            message:Localized(@"BLOCK_BEHAVIOR_EXPLANATION",
                                                        @"An explanation of the consequences of blocking another user.")
                                     preferredStyle:UIAlertControllerStyleActionSheet];

    UIAlertAction *unblockAction = [UIAlertAction
        actionWithTitle:Localized(@"BLOCK_LIST_BLOCK_BUTTON", @"Button label for the 'block' button")
          ...
          completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    [self showOkAlertWithTitle:Localized(
                                   @"BLOCK_LIST_VIEW_BLOCKED_ALERT_TITLE", @"The title of the 'user blocked' alert.")
                       message:[NSString
                                   stringWithFormat:Localized(@"BLOCK_LIST_VIEW_BLOCKED_ALERT_MESSAGE_FORMAT",
                           ...
                           completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    NSString *title = [NSString stringWithFormat:Localized(@"BLOCK_LIST_UNBLOCK_TITLE_FORMAT",
    ...
    UIAlertAction *unblockAction = [UIAlertAction
        actionWithTitle:Localized(@"BLOCK_LIST_UNBLOCK_BUTTON", @"Button label for the 'unblock' button")
                  style:UIAlertActionStyleDestructive
                handler:^(UIAlertAction *_Nonnull action) {
            ...
            completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    [self showOkAlertWithTitle:Localized(@"BLOCK_LIST_VIEW_UNBLOCKED_ALERT_TITLE",
                                   @"The title of the 'user unblocked' alert.")
                       message:[NSString
                                   stringWithFormat:Localized(@"BLOCK_LIST_VIEW_UNBLOCKED_ALERT_MESSAGE_FORMAT",
             ...
             completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    [self showOkAlertWithTitle:Localized(@"BLOCK_LIST_VIEW_BLOCK_FAILED_ALERT_TITLE",
                                   @"The title of the 'block user failed' alert.")
                       message:Localized(@"BLOCK_LIST_VIEW_BLOCK_FAILED_ALERT_MESSAGE",
                                   @"The title of the 'block user failed' alert.")
            fromViewController:fromViewController
               completionBlock:completionBlock];
}
               ...
               completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    [self showOkAlertWithTitle:Localized(@"BLOCK_LIST_VIEW_UNBLOCK_FAILED_ALERT_TITLE",
                                   @"The title of the 'unblock user failed' alert.")
                       message:Localized(@"BLOCK_LIST_VIEW_UNBLOCK_FAILED_ALERT_MESSAGE",
                                   @"The title of the 'unblock user failed' alert.")
            fromViewController:fromViewController
               completionBlock:completionBlock];
}
