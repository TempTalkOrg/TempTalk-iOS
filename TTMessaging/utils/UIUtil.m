...
{
    UINavigationBar.appearance.barTintColor = Theme.backgroundColor; // Theme.navbarBackgroundColor;
    UINavigationBar.appearance.tintColor = Theme.primaryIconColor;
    UITabBar.appearance.barTintColor = Theme.tabbarBackgroundColor;
    UITabBar.appearance.tintColor = Theme.tabbarTitleSelectedColor;
    ...
    [[UISwitch appearance] setTintColor:Theme.hairlineColor];
