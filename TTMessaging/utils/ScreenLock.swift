...
public class ScreenLock: NSObject {
   ...
   @objc public let screenLockTimeouts = [
    ...
    @objc public func tryToUnlockScreenLock(success: @escaping (() -> Void),
        ...
        let localReason = String(format: Localized("SCREEN_LOCK_REASON_UNLOCK_SCREEN_LOCK", "Description of how and why Signal iOS uses Touch ID/Face ID/Phone Passcode to unlock 'screen lock'."), TSConstants.appDisplayName)
        
        tryToVerifyLocalAuthentication(localizedReason: localReason,
    ...
    private func tryToVerifyLocalAuthentication(localizedReason: String,
        ...
        let defaultErrorDescription = Localized("SCREEN_LOCK_ENABLE_UNKNOWN_ERROR",
