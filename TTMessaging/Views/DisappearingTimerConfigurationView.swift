...
public class DisappearingTimerConfigurationView: UIView {
    ...
    public init(durationSeconds: UInt32) {
        ...
        self.label = UILabel()
        label.text = String.formatDurationLossless(durationSeconds: durationSeconds)
        ...
        let hintFormatString = Localized("DISAPPEARING_MESSAGES_HINT", comment: "Accessibility hint that contains current timeout information")
